...
)
{
    ...
    vsetmul(rmul,cmul);
    packfp64_tile(Ap, "Ap", A, "A", mu, lambda_eff, K, rmul);
    packfp64_tile(Bp, "Bp", B, "B", nu, lambda_eff, K, cmul);
    ...
    microgemm_portable(M, N, K, Ap, Bp, alpha, D, N, LMUL);
